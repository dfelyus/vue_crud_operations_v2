        ...
        <nav class="navbar navbar-expand-lg bg-light">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <RouterLink to="/home" class="nav-link" aria-current="page">All books</RouterLink>
                    </li>
                    <li class="nav-item">
                        <RouterLink to="/add_book" class="nav-link active" aria-current="page">Add book</RouterLink>
                    </li>
